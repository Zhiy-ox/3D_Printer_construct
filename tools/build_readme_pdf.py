    ...
    story.append(
        bullets(
            [
                ...
                "Use <font name='Courier'>StageZConvention=false</font> for positive Z output, or the GUI <font name='Courier'>Z +</font> button next to Offset Z / sign.",
    ...
    story.append(
        param_table(
            [
                ...
                ("StageZConvention", "Controls output Z sign.", "true writes negative stage Z; false writes positive Z, such as +0.00025."),
